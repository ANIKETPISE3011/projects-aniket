...
data = pd.read_csv("C:\\RIC\\scores.csv") 
data.head()
...
y = [] 
yerror = [] 
#Assigns the mean score and 95% confidence limit to each district for district in x:
for distinct in x:
...
###################### Perform 1-way ANOVA 
print(stats.f_oneway(district_dict['Brooklyn'], district_dict['Bronx'], district_dict['Manhattan'], district_dict['Queens'], district_dict['Staten Island'])) 
