...
datafile='C:\\RIC\\ToothGrowth.csv'
...
ssq_a=sum([(data[data.supp==1].len.mean()-grand_mean)**2 for l in data.supp])
#sum of square B-supp
ssq_b=sum([(data[data.supp==1].len.mean()-grand_mean)**2 for l in data.supp])
